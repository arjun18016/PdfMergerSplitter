...
The test checks whether the package name of the target app is equal to "com.arjun.pdfmergespilt" using assertEquals().
...
public class ExampleInstrumentedTest {
    ...
    public void useAppContext() {
        ...
        assertEquals("com.arjun.pdfmergespilt", appContext.getPackageName());
    }
}
